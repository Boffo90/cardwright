...
## Current version
2.16.0 (see `changelog_ai.md`). App renamed **ProxyForge → Cardwright** in v2.8.0 (July 2026); GitHub repo is `Boffo90/cardwright` (old URL redirects). Publicly launched on Reddit (r/mtgproxies) with mostly positive feedback; v2.9.0 acts on that feedback, v2.11.0 added Yu-Gi-Oh search and v2.12.0 the visual revamp.
